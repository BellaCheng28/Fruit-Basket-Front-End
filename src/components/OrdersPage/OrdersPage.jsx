  ...
  {orders.length === 0 ? (
    <div className="text-center">
      <p className="text-gray-600 mb-4">
        You don't have any orders yet. Would you like to go to the shopping page?
      </p>
      <button
        ...
        >
          ...
          <div className="space-y-6">
            {order.orderItems_id.map((item) => (
              <div
                key={item._id}
                className="p-4 bg-white border rounded-lg shadow-sm hover:bg-gray-50 transition duration-300"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Price: ${item.purchasePrice}</p>
